<x-jet-action-section>
    ...
    <x-slot name="content">
        ...
        <p class="mt-3">
            {{ __('No ha habilitado la autenticación de dos factores. Cuando la autenticación de dos factores está habilitada, se le solicitará un token seguro y aleatorio durante la autenticación. Puede recuperar este token de la aplicación Google Authenticator de su teléfono.') }}
        </p>
